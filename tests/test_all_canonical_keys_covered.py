...
def test_all_canonical_keys_covered_by_testdata():
    ...
    ALLOWED_MISSING = {
        ...
        "heating_summer_mode",
        "heating_summer_outside_temp",
        "heating_summer_heat_buffer",
        "heating_pump_cycles",
        "heating_external_source",
        "heating_external_curve_gap",
        "heating_external_blocking_time",
        "heating_external_dual_mode_temp",
        "heating_external_lower_limit",
        # DHW configuration keys (only in s=4,3,X pages, not main snapshots)
        "dhw_comfort_temperature",
        "dhw_eco_temperature",
        "dhw_mode",
        "dhw_hysteresis",
        "dhw_stages",
        "dhw_learning_function",
        "dhw_combi_cylinder",
        "dhw_output_summer",
        "dhw_output_winter",
        "dhw_max_flow_temp",
        "dhw_pasteurisation",
        "dhw_pasteurisation_temp",
        "dhw_external_source",
